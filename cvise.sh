...
cat > lines << EOF
  constexpr auto x = ::folly::makeFixedString("abcdefghijklmnopqrstuvwxyz"), y = x;
#ifdef BAD
...
sed "/MARKER/r lines" ${input} | sed "/MARKER/d" > ${fname}
